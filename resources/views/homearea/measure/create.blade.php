...
<div class="col-md-12">
    <div class="card">
        ...
        @endif
        {!! Form::open(array('route' => 'measure.store','method'=>'POST')) !!}
            <div class="card-body">
                @foreach($field as $v)
                    @switch($v['title'])
                        @case('量測名稱')
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    {!! Form::text('title', null, array('placeholder' => $v['title'],'class' => 'form-control', 'id' => 'inputTitle')) !!}
                                </div>
                            </div>
                            @break
                        @case('量測URL')
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    {!! Form::text('link', null, array('placeholder' => '量測URL','class' => 'form-control', 'id' => 'inputLink')) !!}
                                </div>
                            </div>
                            @break
                        @case('主圖URL')
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    {!! Form::text('image', null, array('placeholder' => '主圖URL','class' => 'form-control', 'id' => 'inputImage')) !!}
                                </div>
                                <div class="col-sm-3">
                        ...
                        @case('上架時間')
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    @endphp
                                    <x-adminlte-input-date name="start" value="{{date('Y-m-d H:i')}}" :config="$StartDateConfig">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    @endphp
                                    <x-adminlte-input-date name="end" value="{{date('Y-m-d 23:59',strtotime('+1 week'))}}" :config="$EndDateConfig">
                                        <x-slot name="appendSlot">
                                            <div class="input-group-text bg-gradient-info">
                                                <i class="fas fa-calendar-alt"></i>
                                            </div>
