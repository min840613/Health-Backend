...
@section('title', '內容置頂 － 新增')

@section('content_header')
    <h1>內容置頂{{empty($rightBar) ? '' : ('：'.$rightBar->name)}} － 新增</h1>
@stop
...
@section('content')
    <div class="col-md-12">
        <div class="card">
            ...
            @endif
            {!! Form::open(['url' => route('detail.store', ['right_bar' => $rightBar->id]),'method'=>'POST']) !!}
            <div class="card-body">
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label column-required" name="article_id_label">文章ID</label>
                    <div class="col-sm-10">
                        <x-adminlte-input name="article_id" required/>
                ...
                <div class="form-group row">
                    ...
                    @endphp
                    <x-adminlte-input-date name="published_at" value="{{date('Y-m-d H:i')}}" :config="$StartDateConfig" required>
                ...
                <div class="form-group row">
                    ...
                    @endphp
                    <x-adminlte-input-date name="published_end" value="{{date('Y-m-d 23:59',strtotime('+1 week'))}}" :config="$EndDateConfig" required>
                        <x-slot name="appendSlot">
                            <div class="input-group-text bg-gradient-info">
                                <i class="fas fa-calendar-alt"></i>
                            </div>
