...
@section('content')
    <div class="col-md-12">
        <div class="card">
            ...
            @endif
            {!! Form::open(['route' => 'home_taxon.store','method'=>'POST']) !!}
            <div class="card-body">
                ...
                <div class="form-group row publish_area" style='display:none;'>
                    ...
                    @endphp
                    <x-adminlte-input-date name="published_end" value="{{date('Y-m-d 23:59',strtotime('+1 week'))}}" :config="$EndDateConfig">
                        <x-slot name="appendSlot">
                            <div class="input-group-text bg-gradient-info">
                                <i class="fas fa-calendar-alt"></i>
                            </div>
