...
<div class="col-md-12">
    <div class="card">
        ...
        @endif
	    {!! Form::model($feature, ['method' => 'PATCH','route' => ['feature_manage.update', $feature->id]]) !!}
        @csrf
            <div class="card-body">
                ...
                <div class="form-group">
                    <div class="custom-control custom-switch">
                        ...
                        <input name="active_at" type="checkbox" class="custom-control-input" id="customSwitch1" checked>
                        @else
