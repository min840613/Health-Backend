    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="content">
                    <div id="validateMsg" class="alert alert-danger" style="display: none;"></div>
                    <form id="editForm" name="editForm" class="form-horizontal" onsubmit="return false;">
                        ...
                        @foreach ($editField as $key => $value)
                            ...
                            <div class="form-group row {!! isset($value['main_class'])?$value['main_class']:'' !!}">
                                <label class="col-sm-3 col-form-label input_{{ $value['name'] }} @error($value['name']) text-red @enderror" for="{{ $value['name'] }}">
                            ...
                            @switch($value['type'])
                                ...
                                @case('datetime')
                                    @feature(isset($value['feature'])?$value['feature']:'nofeature',isset($value['feature'])?true:false)
                                    <div class="col-sm-9">
                                        <x-adminlte-date-range name="{{$value['name']}}" id="{{$value['name']}}">
