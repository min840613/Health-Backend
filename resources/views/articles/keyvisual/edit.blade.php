...
<div class="col-md-12">
    <div class="card">
        ...
        @endif
        {!! Form::model($data, ['method' => 'PATCH','route' => ['keyvisual.update', $data->keyvisual_id]]) !!}
            <div class="card-body">
                    ...
                    @switch($v['title'])
                        ...
                        @case('發佈時間')
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input type="hidden" id="startOrigin" value="{{$data['start']}}" >
                                    <x-adminlte-date-range name="start" autocomplete="off">
                                ...
                                <div class="col-sm-4">
                                    <input type="hidden" id="endOrigin" value="{{$data['end']}}" >
                                    <x-adminlte-date-range name="end" autocomplete="off">
                                        <x-slot name="appendSlot">
                                        <div class="input-group-text bg-gradient-info">
                                            <i class="fas fa-calendar-alt"></i>
                                        </div>
