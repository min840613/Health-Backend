...
@section('content_header')
    ...
    <h1>Line 文章供稿</h1>
    {{ Form::open(['id' => 'search', 'route' => 'line_articles.list', 'method' => 'get', 'style' => 'border:1px solid #ccc; padding: 5px;']) }}
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.reset').click(function () {
                location.href = "{{route('line_articles.list')}}"
            })
        ...
        function changeStatus(){
            ...
            lineFormData.append('Id', Id);

            lineFormData.append('_method', 'PATCH');
            ...
            $.ajax({
            data: lineFormData,
            url: '{{route("line_articles.changeStatus")}}',
            type: 'POST',
            dataType: 'JSON',
            cache: false,
            processData: false,
        ...
        function deleteLine(){
            ...
            lineFormData.append('Id', Id);
            lineFormData.append('ArticlesId', ArticlesId);

            lineFormData.append('_method', 'DELETE');
            ...
            $.ajax({
            data: lineFormData,
            url: '{{route("line_articles.delete")}}',
            type: 'POST',
            dataType: 'JSON',
            cache: false,
            processData: false,
