                        ...
                        @switch($value['type'])
                            @case('text')
                                @feature(isset($value['feature'])?$value['feature']:'nofeature',isset($value['feature'])?true:false)
                                    ...
                                    @if ($value['id'] == 'android_image')
                                    <div class="form-group row"></div>
                                    <div class="form-group row">
                                        <div class="col-sm-6">
                                            <a id="gallery_android_image" class="btn btn-success btn-flat float-left px-4 android-img" href="javascript:;">圖庫</a>
                                            <a id="review_android_image_click" class="btn btn-success btn-flat float-left px-4 ml-4" href="javascript:;">預覽</a>
                                        </div>
                                    </div>
                                    <div id="review_android_image_div" class="col-sm-12 mt-4" style="display: none;">
                                        <div class="row">
                                            <label class="col-sm-2"></label>
                                            <div class="col-sm-10">
                                                <img id="review_android_image" style="height: 100px;" src="" />
                                            </div>
                                        </div>
                                    </div>
                                    @endif
                                    @if ($value['id'] == 'iOS_image')
                                    <div class="form-group row"></div>
                                    <div class="form-group row">
                                        <div class="col-sm-6">
                                            <a id="gallery_ios_image" class="btn btn-success btn-flat float-left px-4 ios-img" href="javascript:;">圖庫</a>
                                            <a id="review_ios_image_click" class="btn btn-success btn-flat float-left px-4 ml-4" href="javascript:;">預覽</a>
                                        </div>
                                    </div>
                                    <div id="review_ios_image_div" class="col-sm-12 mt-4" style="display: none;">
                                        <div class="row">
                                            <label class="col-sm-2"></label>
                                            <div class="col-sm-10">
                                                <img id="review_ios_image" style="height: 100px;" src="" />
                                            </div>
                                        </div>
                                    </div>
                                    @endif
