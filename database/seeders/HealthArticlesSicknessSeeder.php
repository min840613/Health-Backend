...
class HealthArticlesSicknessSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        DB::transaction(function () {
            $result = DB::connection('mysql_tvbs_v4')->table('health_articles_sickness')->get();
            ...
            ArticlesSicknessModel::insert($result);
        });
    }
}
