...
class HealthCategoriesSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        DB::transaction(function () {
            $result = DB::connection('mysql_tvbs_v4')->table('health_categories')->get();
            ...
            foreach($result as $k => $v){
                ...
                if($result[$k]['publish'] == '0000-00-00 00:00:00'){
                    $result[$k]['publish'] = date('Y-m-d H:i:s');
                }
            ...
            MainCategoriesModel::insert($result);
        });
    }
}
