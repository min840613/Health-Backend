...
/**
 * Class HealthSystemAnnouncementSeeder
 * @package Database\Seeders
 */
class HealthSystemAnnouncementSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        DB::transaction(function () {
            $result = DB::connection('mysql_tvbs_v4')->table('health_system_announcement')->get();
            ...
            SystemAnnouncementModel::insert($result);
        });
    }
}
