 ...
 */
     ...
     */ 
         ...
         *
         * @see \App\Providers\AppServiceProvider::boot()
         * @param mixed $viewPage
         * @param mixed $data
         * @static 
         */ 
        public static function xml($viewPage, $data)
        {
                        return \Illuminate\Routing\ResponseFactory::xml($viewPage, $data);
        }
...
')
     ...
     * 
     *
     * @see \App\Helpers\IndexingHelper
     */ 
         ...
         *
         * @param string $driver
         * @return \App\Helpers\Indexing\IndexingInterface 
         * @static 
         */ 
        public static function driver($driver)
        {
                        /** @var \App\Helpers\IndexingHelper $instance */
                        return $instance->driver($driver);
        }
...
namespace  { 
            ...
            class Indexing extends \Facades\App\Helpers\IndexingHelper {}
